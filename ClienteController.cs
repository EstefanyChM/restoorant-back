...
namespace ApiWeb.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        public ClienteController(IMapper mapper, IClienteBussnies clienteBussnies, IOnlineUserBusiness onlineUserBusiness)
        {
            _mapper = mapper;
            _ClienteBussnies = clienteBussnies;
            _onlineUserBusiness = onlineUserBusiness;
            _PersonaBussnies = new PersonaNaturalBussnies(mapper);
        }
